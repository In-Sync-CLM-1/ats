// Mux remotion visual + narration + music bed -> Downloads\ats-promo*.mp4
//   node scripts/mux-remotion-promo.mjs [visualPath] [outPath]
import { execFileSync } from 'child_process';
import { join } from 'path';
import * as V from 'file:///C:/Users/Admin/ats/scripts/lib/video.mjs';

const FF = 'C:\\Users\\Admin\\scoop\\shims\\ffmpeg.exe';
const scenes = 'C:\\Users\\Admin\\ats\\scripts\\recordings\\scenes';
const silent = process.argv[2] || 'C:\\Users\\Admin\\ats\\remotion-promo\\out\\promo-visual.mp4';
const narr = join(scenes, 'promo-narration.mp3');
const music = 'C:\\Users\\Admin\\ats\\scripts\\assets\\promo-bed.mp3';
const mixed = join(scenes, 'promo-remotion-mixed.mp4');
const OUT = process.argv[3] || 'C:\\Users\\Admin\\Downloads\\ats-promo.mp4';
