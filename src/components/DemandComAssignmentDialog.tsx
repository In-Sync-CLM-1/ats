...
export function DemandComAssignmentDialog({
  ...
  const handleAssign = async () => {
    ...
    try {
      ...
      // Keep edge function name for API compatibility
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>Assign Selected Candidates</DialogTitle>
          <DialogDescription>
            You are about to assign {selectedIds.length} selected candidate(s)
          </DialogDescription>
        </DialogHeader>
...
export { DemandComAssignmentDialog as CandidateAssignmentDialog };
