...
const TABLE_COLUMNS: Record<string, { field: string; label: string; type: string }[]> = {
  demandcom: [ // Keep table name 'demandcom' in database, UI shows "Candidates"
  ...
  master: [
    ...
    { field: "phone_secondary", label: "Secondary Phone", type: "text" },
    { field: "email", label: "Email", type: "email" },
    { field: "position_applied_for", label: "Position Applied For", type: "text" },
    { field: "current_status", label: "Current Status", type: "text" },
    { field: "interview_stage", label: "Interview Stage", type: "text" },
    { field: "current_company", label: "Current Company", type: "text" },
    { field: "designation", label: "Designation", type: "text" },
    { field: "total_experience_years", label: "Total Experience (Years)", type: "number" },
    { field: "current_ctc_lakhs", label: "Current CTC (Lakhs)", type: "number" },
    { field: "expected_ctc_lakhs", label: "Expected CTC (Lakhs)", type: "number" },
    { field: "highest_qualification", label: "Highest Qualification", type: "text" },
    { field: "key_skills", label: "Key Skills", type: "text" },
