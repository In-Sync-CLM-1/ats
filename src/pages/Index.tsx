      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            ...
            advanced analytics, and seamless ATS integration
          </p>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 mb-16">
          ...
          <div className="glass-card p-6 hover-lift">
            ...
            <h3 className="text-xl font-bold mb-2">ATS Integration</h3>
            <p className="text-muted-foreground">
              Seamlessly integrate with your Applicant Tracking System for 
          ...
          <div className="glass-card p-6 hover-lift">
            ...
            <p className="text-muted-foreground">
              Track recruitment metrics, placement rates, and team performance 
              in real-time
            </p>
          </div>
        ...
        <div className="text-center glass-card p-12 rounded-2xl">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join healthcare staffing agencies using ATS to streamline their
