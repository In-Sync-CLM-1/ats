...
export default function PipelineStages() {
  ...
  const [stageTypeFilter, setStageTypeFilter] = useState<string>("candidate");
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              <DialogTrigger asChild>
                <Button onClick={() => {
                  ...
                  setFormData({ name: "", description: "", stage_order: nextOrder.toString(), stage_type: "candidate", color: "#3b82f6" });
                }}>
        ...
        <CardContent>
          <div className="flex items-center gap-2 mb-4">
            ...
            <Select value={stageTypeFilter} onValueChange={setStageTypeFilter}>
              ...
              <SelectContent>
                <SelectItem value="candidate">Candidate Stages</SelectItem>
